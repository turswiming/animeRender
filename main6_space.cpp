...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(screenWide, screenHeight, "AnimeRenderer", nullptr, nullptr);
    if (window == nullptr)
    {
...
// note that we're translating the scene in the reverse direction of where we want to move
        ...
        glm::mat4 projection;
        projection = glm::perspective(glm::radians(45.0f), (float)screenWide / (float)screenHeight, 0.1f, 100.0f);
